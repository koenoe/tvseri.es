...
const markerVariants = cva('absolute w-0.5 -translate-x-1/2 left-3/4', {
  defaultVariants: { variant: 'normal' satisfies PercentileBarVariant },
  variants: {
    variant: {
  ...
  return (
    <div className="w-full">
      ...
      <div className="relative w-full">
            ...
            return (
              <Tooltip delayDuration={300} key={zone.status}>
                <TooltipTrigger asChild>
                  <span className={segmentClassName} style={widthStyle} />
                </TooltipTrigger>
                <TooltipContent>
        ...
        <div className={`${markerVariants({ variant })} ${markerColor}`} />
      </div>

      {showP75Label ? (
        <div className="relative h-8">
          <div className="absolute mt-2 flex w-0 flex-col items-center justify-center left-3/4">
