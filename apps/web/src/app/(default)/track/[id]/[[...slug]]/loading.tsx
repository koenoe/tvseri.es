    ...
    <SkeletonPage>
      <div className="container">
        <div className="flex gap-6 md:gap-10">
          <div className="h-[113px] w-[75px] md:h-[189px] md:w-[126px] lg:h-[225px] lg:w-[150px] flex-shrink-0 animate-pulse rounded-xl bg-white/5" />
          <div className="relative w-full">
            <div className="mb-2 h-6 w-48 animate-pulse bg-white/15 lg:h-8 lg:w-64" />
            <div className="h-4 w-36 animate-pulse bg-white/10" />
            <div className="mt-5 hidden w-full max-w-4xl md:block">
              <div className="h-4 w-full animate-pulse bg-white/5 leading-loose" />
              <div className="mt-2 h-4 w-3/4 animate-pulse bg-white/5" />
            </div>
